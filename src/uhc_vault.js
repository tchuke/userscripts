...
// @include      https://provider.linkhealth.com/coreb2c/esrMpinPickList.do*
// @include      https://provider.linkhealth.com/coreb2c/ProviderTaxidAction.do*
// @include      https://provider.linkhealth.com/coreb2c/medicareSolReport.do*
...
(function () {
    ...
    function addIframeFun(id, payerValueToSelect, reportValueToSelect) {
        ...
        return () => {
            ...
            myIFrame.
                attr('src', "https://provider.linkhealth.com/coreb2c/esrMpinPickList.do").
                attr('height', 500).
                attr('width', 500).
